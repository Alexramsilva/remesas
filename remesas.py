...
# app.py
# Streamlit app: ¿Es buen momento para enviar remesas de EE.UU. a México?
...
# =============================
st.set_page_config(page_title="Remesas EE.UU. → México", layout="centered")

st.title("💸 ¿Conviene enviar remesa hoy?")
...
def get_news():
    ...
    if news is None:
        return []
    return news[:5]  # últimas 5 noticias

news_items = get_news()

st.subheader("📰 Noticias financieras recientes (USD/MXN)")
...
# =============================
# Regla simple:
# - Conviene enviar si USD/MXN está arriba de su promedio reciente
# - Y el sentimiento no es claramente negativo

if (current_fx > mean_fx) and (sentiment != "negative"):
    decision = "✅ PROPICIO enviar remesa"
    color = "green"
elif (current_fx > mean_fx) and (sentiment == "negative"):
    decision = "⚠️ Tipo de cambio bueno, pero riesgo macro"
    color = "orange"
else:
    decision = "❌ NO es buen momento para enviar"
    color = "red"
...
# Gráfica
# =============================
st.subheader("📈 Evolución USD/MXN")
st.line_chart(fx['Close'])

# =============================
# Disclaimer
# =============================
st.caption("⚠️ Herramienta educativa. No constituye recomendación financiera. Heurística simplificada.")
